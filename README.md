...
|---|---|
| [nn-fundamentals](https://github.com/Sid1005/nn-fundamentals) | Neural networks from scratch, to understand what powers LLMs |
| [clip](https://github.com/Sid1005/clip) | How multimodal LLMs see images: CLIP encoder and projection |

## Open source

- **Haskell Language Server.** Shipped Cabal file autocomplete for autogen-modules and autogen-includes. [PR](https://github.com/haskell/haskell-language-server/pull/4535)

## Experience

- **Nutanix** · Software engineering intern, Network Security · Bangalore
- **Avidia Labs** · Business development intern, EdTech

## Education

- **BITS Pilani, Hyderabad** · MSc Mathematics + BE Computer Science · 2026
- GMAT Focus 725, 99th percentile

## Outside of code

Captained BITS Hyderabad's Ultimate Frisbee team. Grew the roster from 13 to 52, the largest in program history, and finished 2nd in the country.
